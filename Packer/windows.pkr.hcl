source "azure-arm" "autogenerated_1" {
  ...
  client_id                         = "b6fa2007-8chfgffd4ecf66"
  client_secret                     = "B18Q08u8u8uhuhlFMOa77"
  communicator                      = "winrm"
  ...
  os_type                           = "Windows"
  subscription_id                   = "2b8ajjij,m,kljlkljd669513f4ba"
  tenant_id                         = "34274kjjjhjkj2a75908"
...
build {
  ...
  provisioner "file" {
    ...
    destination = "/tmp/windows-update.ps1"
  }
